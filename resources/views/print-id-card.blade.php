...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <button onclick="window.print()"
        class="fixed top-4 right-4 bg-blue-600 text-white px-4 py-2 rounded-lg shadow-lg hover:bg-blue-700 print:hidden">
        Print ID Card
    </button>
    ...
    <div class="id-card-container">
        <div
            class="id-card w-[85.6mm] h-[54mm] bg-white rounded-lg shadow-xl overflow-hidden relative border-2 border-gray-200">
            ...
            <div class="flex h-full">
                ...
                <div
                    ...
                    @if ($user['company_logo'])
                        <img src="{{ asset('storage/logos/' . $user['company_logo']) }}"
                            class="w-16 h-16 mb-1 filter brightness-0 invert">
                    @else
                    ...
                    @endif
                    {{-- <img src="{{ asset('images/company-logo.png') }}" class="w-16 h-16 mb-1 filter brightness-0 invert"> --}}
                ...
                <div class="w-2/3 p-1.5 flex flex-col justify-between">
                    <!-- Header -->
                    <div class="mb-1">
                        <h1 class="text-[8px] font-bold text-blue-800 uppercase tracking-wide">
                            {{ $user['company_name'] }}</h1>
                        <p class="text-[5px] text-gray-600">{{ $user['company_type'] }}</p>
                    </div>
                    ...
                    <div class="mt-1 border-t border-gray-200 pt-0.5">
                        <div class="flex justify-between items-center">
                            ...
                            <!-- QR Code -->
                            <div class="w-10 h-10 d-flex bg-white border border-gray-200 rounded-sm">
                                <img class="qr-code w-full h-full"
                                    src="data:image/svg+xml;base64,{{ $user['qr_code'] }}" alt="QR Code">
                            </div>
                        </div>
                    </div>
                </div>
